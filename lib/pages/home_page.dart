...
import 'package:prayerapp/models/todo.dart';
import 'dart:async';
...
//  }
  ...
  UpdateFirebaseValue(String type, String val1, String val2) {
    if (type == "prayer") {
      _database.reference().child(type).update({'text': val1, 'time': val2});
    } else {
      _database.reference().child(type).update({'text': val1});
    }
  }
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              new FlatButton(
                  ...
                  onPressed: () {
                    UpdateFirebaseValue(
                        val, _textEditingController.text.toString(), "");
                    Navigator.pop(context);
                  })
            ],
          );
